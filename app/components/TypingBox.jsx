...
export const TypingBox = () => {
  const askAI = useAINaruto((state) => state.askAI);
  ...
  return (
    <div className="z-10 max-w-[600px] flex space-y-6 flex-col bg-gradient-to-tr  from-slate-300/30 via-gray-400/30 to-slate-600-400/30 p-4  backdrop-blur-md rounded-xl border-slate-100/30 border">
      <div>
        <h2 className="text-white font-bold text-xl">Ask naruto sensei</h2>
        <p className="text-white/65">
          Ask anything about naruto series and naruto sensei will answer it for
          you.
        </p>
      </div>
      ...
      {loading ? (
        ...
        <div className="gap-3 flex">
          <input
            ...
            placeholder="Who is naruto's best friend?"
            value={question}
